...
async def show_service_details(query, service_id, category):
    ...
    try:
        ...
        message = (
            ...
            f"• Call me:  +963957248651\n"             
            f"• Telegram: +963957248651\n"
            f"• WhatsApp: https://wa.me/message/IBB5SPQJR4LLP1\n\n"
...
async def show_contact(query):
    ...
    try:
        message = (
            ...
            "📞 Call me: +963957248651\n"
            "📱 Telegram: +963957248651\n"
            "📞 WhatsApp: https://wa.me/message/IBB5SPQJR4LLP1\n"
            "🕒 الوقت: 24/7\n\n"
